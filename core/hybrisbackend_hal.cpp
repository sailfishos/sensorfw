...
{
    return qobject_cast<HybrisBackend *>(new HybrisBackendHal(manager));
}

HybrisBackendHal::HybrisBackendHal(HybrisManager *manager, QObject *parent)
...
void HybrisBackendHal::eventReaderThreadImpl()
{
